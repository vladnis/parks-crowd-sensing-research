...
var numberOfPeople = 700;

var NUM_MINUTES = 120;

var NUM_ITERATIONS = NUM_MINUTES * 900 / 60;
...
function calculateArea(circles, poly) {
    ...
    var parkArea = 1404409.9;
    console.log("Procentage covered:", count * area3 / parkArea * 100);
...
MongoClient.connect('mongodb://localhost:27017/park', function(err, db) {
    ...
    cursor.each(function(err, doc) {
        ...
        if (doc === null) {
            ...
            calculateArea(uniquePointsCovered, polys);
